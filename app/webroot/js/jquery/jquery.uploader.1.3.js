...
(function($) {
	...
	$.fn.uploader = function(config){
		...
		var pxUploadForm = 'px-form-' + $.uploader.count,
		pxWidget = 'px-widget-' + $.uploader.count,
		pxButton = 'px-button-' + $.uploader.count,
		wrapper = ' \
			...
			$(pxUploadForm).append(
				...
				.append(' \
					<ul class="actions ui-helper-clearfix"> \
						...
						<li title="删除" class="delete ui-state-default ui-corner-all"> \
