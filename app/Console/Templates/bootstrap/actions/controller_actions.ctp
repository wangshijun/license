...
<?php
	...
	public function <?php echo $admin; ?>delete($id = null) {
		...
		$deleted = $this-><?php echo $currentModelName; ?>->delete();
<?php if ($wannaUseSession): ?>
		if ($this->Session->read('<?php echo $currentModelName; ?>.deleted') === true) {
			$this->Session->delete('<?php echo $currentModelName; ?>.deleted');
