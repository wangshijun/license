...
$i = 0;
	...
	<div class="related">
		...
		<table cellpadding="0" cellspacing="0"  class="<?php echo strtolower($otherPluralHumanName);?> table table-bordered table-striped">
			<thead>
				<tr>
<?php
	foreach ($details['fields'] as $field) {
...
?>
			...
			<tbody>
<?php echo "\t\t\t\t<?php \$i = 0; foreach (\${$singularVar}['{$alias}'] as \${$otherSingularVar}): ?>\n";
			echo "\t\t\t\t<tr>\n";
				foreach ($details['fields'] as $field) {
