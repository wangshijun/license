...
<?php echo "\t<?php echo \$this->BootstrapForm->create('" . $singularHumanName . "', array('url' => array_merge(array('action' => 'search'), \$this->params['pass']), 'class' => 'search form-search form-inline'));?>\n"; ?>
