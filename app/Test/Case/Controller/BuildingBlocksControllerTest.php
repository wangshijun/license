<?php
App::uses('BuildingBlocksController', 'Controller');

/**
 * TestBuildingBlocksController *
 */
class TestBuildingBlocksController extends BuildingBlocksController {
/**
 * Auto render
 *
 * @var boolean
...
/**
 * BuildingBlocksController Test Case
 *
 */
class BuildingBlocksControllerTestCase extends CakeTestCase {
/**
 * Fixtures
 *
 * @var array
