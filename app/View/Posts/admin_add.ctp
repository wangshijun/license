<div class="<?php echo $inflector['underscore'];?> form">
	...
	<fieldset>
		<legend><?php echo __('Add ' . $inflector['camelize']); ?></legend>

		<?php echo $this->BootstrapForm->input('author_id', array('type' => 'hidden', 'value' => $author_id)); ?>

		<?php echo $this->BootstrapForm->hidden('published', array('type' => 'hidden', 'value' => 0)); ?>
	...
	<div class="form-actions">
		...
		<input type="submit" id="publish" class="btn btn-success btn-large" value="<?php echo __('Publish');?>">
	</div>
...
jQuery(function () {
	var form = $('#<?php echo $inflector['camelize'];?>AdminAddForm');
