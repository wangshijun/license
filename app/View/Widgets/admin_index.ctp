<div class="widgets index">
	...
	<table cellpadding="0" cellspacing="0" class="widgets table table-bordered table-striped">
		...
		<?php $i = 0; foreach ($widgets as $widget): ?>
			<tr>
				...
				<td><?php echo h($widget['Widget']['gmt_modified']); ?>&nbsp;</td>
				<td class="actions">
					<?php echo $this->Html->link('<i class="icon-eye-open"></i> ' . __('View'), array('action' => 'view', $widget['Widget']['id']), array('escape' => false, 'class' => 'btn btn-mini')); ?>
					<?php echo $this->Html->link('<i class="icon-edit"></i> ' . __('Edit'), array('action' => 'edit', $widget['Widget']['id']), array('escape' => false, 'class' => 'btn btn-mini')); ?>
					<?php echo $this->BootstrapForm->postLink('<i class="icon-trash"></i> ' . __('Delete'), array('action' => 'delete', $widget['Widget']['id']), array('escape' => false, 'class' => 'btn btn-mini'), __('Are you sure you want to delete # %s?', $widget['Widget']['id'])); ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	...
	<div class="alert alert-info">
		<a class="close" data-dismiss="alert">ĂÂĂÂ</a>
